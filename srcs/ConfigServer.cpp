...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/06 10:35:41 by areheman          #+#    #+#             */
/*   Updated: 2023/07/11 12:35:36 by areheman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//         throw Exception_ConfigServer("socket creat problem ");
// 		//exit(EXIT_FAILURE);
//     }

//     int option_value = 1;
//     setsockopt(s_socketFd, SOL_SOCKET, SO_REUSEADDR, &option_value, sizeof(int));
//     memset(&s_serverAdress, 0, sizeof(s_serverAdress));
//     s_serverAdress.sin_family = AF_INET;
//     s_serverAdress.sin_addr.s_addr = s_host;
//     s_serverAdress.sin_port = htons(s_port);
//     if (bind(s_socketFd, (struct sockaddr *) &s_serverAdress, sizeof(s_serverAdress)) == -1)
//     {
// 		//Logger::logMsg(RED, CONSOLE_OUTPUT, "webserv: bind error %s   Closing ....", strerror(errno));
//         //exit(EXIT_FAILURE);
// 		 throw Exception_ConfigServer("bind problem ");
//     }
// }
