...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/06 10:35:58 by areheman          #+#    #+#             */
/*   Updated: 2023/07/21 19:07:26 by areheman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string upload_list(std::string path)
{
    ...
    while((ents = readdir(directory)) != NULL)
    {
        ...
        //     page.append("<form id=\"deleteForm\" action = \"/upload/");
        //     page.append(ents->d_name);
        //     page.append("\">");
        //     page.append("<input type=\"hidden\" name=\"_method\" value=\"DELETE\">");
        //     page.append("<button type=\"submit\">Delete</button>>");
        //     page.append("</form>");
        //     page.append("<script src=\"js/deleteButton.js\"></script>");
